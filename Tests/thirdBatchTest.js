...
fixture('UI test case 3 for current open job positions')
.page('https://company.trivago.com/open-positions/'); //opening the webpage

test('Should check for heading, button, values for third batch of current open job positions', async t => {
