...
fixture('UI test case 1 for current open job positions')
.page('https://company.trivago.com/open-positions/'); //opening the webpage

test('Should check for heading, button, values for first batch of current open job positions', async t => {
